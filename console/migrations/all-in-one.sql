...
INSERT INTO `cmg_core_model_meta` VALUES (1,1,'site','locale message','false','core','text',NULL),(2,1,'site','language','en-US','core','text',NULL),(3,1,'site','charset','UTF-8','core','text',NULL),(4,1,'site','site title','CMG Demo','core','text',NULL),(5,1,'site','site name','CMSGears','core','text',NULL),(6,1,'site','site url','http://demo.cmsgears.com/templates/multisite/','core','text',NULL),(7,1,'site','smtp','false','email','text',NULL),(8,1,'site','smtp username','','email','text',NULL),(9,1,'site','smtp password','','email','',NULL),(10,1,'site','smtp host','','email','text',NULL),(11,1,'site','smtp port','587','email','text',NULL),(12,1,'site','debug','true','email','text',NULL),(13,1,'site','sender name','Admin','email','text',NULL),(14,1,'site','sender email','demoadmin@cmsgears.com','email','text',NULL),(15,1,'site','contact name','Contact Us','email','text',NULL),(16,1,'site','contact email','democontact@cmsgears.com','email','text',NULL),(17,1,'site','info name','Info','email','text',NULL),(18,1,'site','info email','demoinfo@cmsgears.com','email','text',NULL),(19,1,'site','theme','basic','frontend','text',NULL),(20,1,'site','theme version','1','frontend','text',NULL),(21,1,'site','admin url','http://demo.cmsgears.com/templates/multisite/admin/','admin','text',NULL),(22,1,'site','theme','basic','admin','text',NULL),(23,1,'site','theme version','1','admin','text',NULL);
...
INSERT INTO `cmg_core_site` VALUES (1,'main'),(2,'testsite1'),(3,'testsite2'),(4,'testsite3'),(5,'testsite4'),(6,'testsite5');
...
-- Dump completed on 2015-07-03 10:25:44
