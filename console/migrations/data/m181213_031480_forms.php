...
class m181213_031480_forms extends \cmsgears\core\common\base\Migration {
	...
	private function insertFiles() {
		...
		$files = [
			[ 108001, $site->id, $master->id, $master->id, 'contact', null, 'contact', '', 'jpg', 'banner', 0.3935, 1500, 'image', NULL, '2018-12-29/banner/contact.jpg', '2018-12-29/banner/contact-medium.jpg', NULL, '2018-12-29/banner/contact-thumb.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, DateUtil::getDateTime(), DateUtil::getDateTime(), NULL, NULL, NULL, 0, NULL ]
		];
	...
	private function insertForms() {
		...
		$models = [
			//[ 10001, $site->id, $formTemplate->id, $master->id, $master->id, 'Contact Us', 'contact-us', CoreGlobal::TYPE_FORM, null, null, 'contact form', 'Thanks for contacting us.', true, $vis, $status, false, true, DateUtil::getDateTime(), DateUtil::getDateTime(), null, null ]
		];
	...
	private function updateFormContent() {
		...
		$seo = [
			[ 'Contact Us', 'Contact Us to know more about us and for queries and clarifications.', 'Multisite, Contact, Contact' ]
		];
		...
		$this->update( $this->cmgPrefix . 'cms_model_content', [ 'bannerId' => 108001, 'summary' => $summary[ 0 ], 'seoName' => $seo[ 0 ][ 0 ], 'seoDescription' => $seo[ 0 ][ 1 ], 'seoKeywords' => $seo[ 0 ][ 2 ], 'content' => $content[ 0 ] ], [ 'parentId' => $contactForm->id, 'parentType' => 'form' ] );
	}
